...
export interface AuditLogParams {
  action: 'VIEW_FISCAL_MANAGEMENT' | 'EXPORT_SALES_REPORT' | 'VOID_ORDER' | 'ADJUST_STOCK' | 'MUTATE_ORDER' | 'MANAGER_DISCOUNT_APPROVED' | 'MANAGER_DISCOUNT_DENIED' | 'TRANSFER_DISPATCH' | 'TRANSFER_RECEIVE' | 'TRANSFER_CANCEL' | 'CONSIGNMENT_STATEMENT' | 'CONSIGNMENT_SALE' | 'CONSIGNMENT_RETURN' | 'SETTLEMENT_RECORD' | 'SETTLEMENT_VOID';
